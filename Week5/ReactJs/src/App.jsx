...
// // Hands on - 1
// import Navbar from "./components/Handsons/1_Navbar"
// import Footer from "./components/Handsons/1_Footer"
// import UserList from './components/Handsons/1_UserList';
// function App(){ 
//     // return React element
//     return(
//         <div className="m-20">
...
import FormDemo2 from './components/Handsons/FormDemo2'
import FormDemo2_Validators from "./components/Handsons/FormDemo2_Validators"
function App(){
    return(
        <div>
            <FormDemo2_Validators/>
        </div>
    )
}
export default App;